...
移动互联网的兴起，很多应用都移动化，对于网页的极致优化的要求也越来越高
...
1. 如果用户的当前的有效带宽高于 1.5M/s 我们则认为用户当前网速情况比较快
2. 如果用户的当前的有效带宽小于 1.5M/s 但高于 0.4M/s 我们则认为用户当前网速情况比较理想
3. 如果用户的当前的有效带宽小于 0.4M/s 我们则认为用户当前网速情况比较糟糕
